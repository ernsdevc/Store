...
namespace Services
{
    public class ProductManager : IProductService
    {
        ...
        {
            // var selectedProduct = _manager.Product.GetOneProduct(productDto.ProductId, true);
            // selectedProduct.CategoryId = productDto.CategoryId;
            // selectedProduct.ProductName = productDto.ProductName;
            // selectedProduct.Price = productDto.Price;

            var selectedProduct = _mapper.Map<Product>(productDto);
            _manager.Product.UpdateProduct(selectedProduct);
            _manager.Save();
        }
    }
}